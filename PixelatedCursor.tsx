...
export type PixelatedCursorProps = {
    label?: boolean;
    labelText?: string;
    labelColor?: string;
    labelFont?: LabelFont;
...
export function __OriginkitBase_PixelatedCursor(props: PixelatedCursorProps) {
    const {
...
export default function PixelatedCursor(props: PixelatedCursorProps) {
  return <__OriginkitBase_PixelatedCursor {...(__originkitPresetProps as PixelatedCursorProps)} {...props} />;
}
